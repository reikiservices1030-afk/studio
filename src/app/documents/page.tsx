...
import { MoreHorizontal, Upload, FileText, FileSpreadsheet, FileImage, Loader2, AlertTriangle } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6">
        {corsError && (
             <Alert variant="destructive" className="mb-4">
              ...
              <AlertTitle>Erreur de configuration (CORS)</AlertTitle>
              <AlertDescription>
                Le téléversement de fichiers est bloqué par la politique de sécurité de Firebase Storage. Pour résoudre ce problème, un administrateur doit appliquer la configuration CORS au projet. Le téléversement est désactivé jusqu'à ce que ce problème soit résolu.
              </AlertDescription>
            </Alert>
        )}
        <Card>
